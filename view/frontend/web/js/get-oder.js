define([
    ...
    return function(config) {
        ...
        var options = {
            wrapperClass: 'mavenbird-modals-wrapper',
            modalClass: 'mavenbird-modal',
            overlayClass: 'mavenbird-modals-overlay',
            responsiveClass: 'mavenbird-modal-slide',
            type: 'popup',
            responsive: true,
            innerScroll: true,
            title: title,
            buttons: [{
                ...
                class: 'mavenbird-popup-button',
                click: function (data) {
                    var form_data = $("#mavenbird-refund-form").serialize();
                    if ($('#mavenbird-refund-form').valid()) {
                        ...
                        $.ajax({
                            ...
                            .done(function () {
                                $("#mavenbird-refund-modal").modal('closeModal');
                                $("#mavenbird-refund-form")[0].reset();
        ...
        $(document).on('click', '.refund-order', function () {
            ...
            modal(options, $("#mavenbird-refund-modal"));
            $("#mavenbird-refund-modal").modal('openModal');
            $(".mavenbird-refund-oder-id").attr('value', order_id);
        });
    }
});