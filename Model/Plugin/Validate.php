...
namespace  Mavenbird\RefundRequest\Model\Plugin;
...
class Validate extends \Magento\Config\Controller\Adminhtml\System\Config\Save
{
    ...
    public function aroundExecute($subject, $proceed)
    {
        ...
        if (isset($parameters["mavenbird_refundrequest_email_config"])) {
            $emails = '';
            if (isset($parameters["mavenbird_refundrequest_email_config"]["fields"]["admin_email"]["value"])) {
                $emails = $parameters["mavenbird_refundrequest_email_config"]["fields"]["admin_email"]["value"];
            }
            if ($emails != '') {
